...
class DriveCarrilNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('kp_servo', 20.0)
        self.declare_parameter('max_step_servo', 15)

        # NUEVO: control de reducción de velocidad
        ...
        self.get_logger().info("Drive Carril PRO listo (RQT dinámico)")
    ...
    def error_callback(self, msg):
        ...
        max_step = self.get_parameter('max_step_servo').value
        ...
        # Reduce velocidad proporcional al error
