...
class Init_MotorCommand_turn_signals
{
public:
  explicit Init_MotorCommand_turn_signals(::motor_msgs::msg::MotorCommand & msg)
  : msg_(msg)
  {}
  ::motor_msgs::msg::MotorCommand turn_signals(::motor_msgs::msg::MotorCommand::_turn_signals_type arg)
  {
    msg_.turn_signals = std::move(arg);
...
class Init_MotorCommand_stop_lights
{
public:
  explicit Init_MotorCommand_stop_lights(::motor_msgs::msg::MotorCommand & msg)
  : msg_(msg)
  {}
  Init_MotorCommand_turn_signals stop_lights(::motor_msgs::msg::MotorCommand::_stop_lights_type arg)
  {
    msg_.stop_lights = std::move(arg);
    return Init_MotorCommand_turn_signals(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_MotorCommand_stop_lights dir_servo(::motor_msgs::msg::MotorCommand::_dir_servo_type arg)
  {
    msg_.dir_servo = std::move(arg);
    return Init_MotorCommand_stop_lights(msg_);
  }
