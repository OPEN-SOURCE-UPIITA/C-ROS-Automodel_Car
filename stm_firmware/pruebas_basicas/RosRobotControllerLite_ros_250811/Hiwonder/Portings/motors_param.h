...
#define MOTOR_DEFAULT_TICKS_PER_CIRCLE 1040.0f
#define MOTOR_DEFAULT_PID_KP  -36.0f
#define MOTOR_DEFAULT_PID_KI  -1.0f
#define MOTOR_DEFAULT_PID_KD  -1.0f
#define MOTOR_DEFAULT_RPS_LIMIT 6.0f
