...
static rosidl_typesupport_introspection_c__MessageMember motor_msgs__msg__MotorCommand__rosidl_typesupport_introspection_c__MotorCommand_message_member_array[3] = {
  {
    "dir_dc",  // name
